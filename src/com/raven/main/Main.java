        ...
        menu.addEventMenuSelected(new EventMenuSelected() {
            ...
            public void selected(int index) {
                if (index == 0) {
                    ...
                    setForm(form1);  // Manage Books
                } else if (index == 4) {
                    setForm(form2);  // Issue Books
                } else if (index == 5) {
                    setForm(form3);  // Return Book
                } else if (index == 8) {
                    setForm(form4);  // Manage Students
                } else if (index == 11) {
                    setForm(form5);  // View Records
                } else if (index == 12) {
                    setForm(form6);  // View Issued Books
                } else if (index == 13) {
                    setForm(form7);  // Defaulter List
                }
            }
        });
        ...
        panelBorder1Layout.setHorizontalGroup(
            ...
            .addGroup(panelBorder1Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(header2, javax.swing.GroupLayout.DEFAULT_SIZE, 1180, Short.MAX_VALUE)
